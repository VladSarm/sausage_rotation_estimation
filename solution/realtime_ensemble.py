...
from ensemble_model import AngleEnsemble
from angle_estimation_model import AngleEstimationModel
...
if __name__ == "__main__":
    ...
    model_sin = SinCosResModel()
    model = AngleEnsemble(model_von, model_sin)
    checkpoint = torch.load("/Users/vlad.sarm/Documents/sausage_rotation_estimation/angle_recognition/sincos_/MAE-0.45_EPOCH-2.pth", map_location=device)
